...
const administratorQuickActions = <AdministratorQuickAction>[
  ...
  AdministratorQuickAction(
    ...
    description:
        'Manage the subject catalog, class offerings and pupil elective selections.',
  ),
  AdministratorQuickAction(
    key: 'lifecycle',
