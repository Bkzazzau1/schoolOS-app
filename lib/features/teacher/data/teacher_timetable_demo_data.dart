...
const teacherTimetableKpis = <TeacherTimetableKpi>[
  TeacherTimetableKpi(label: 'Lessons this week', value: '14', hint: 'Across 4 assigned classes'),
  TeacherTimetableKpi(label: "Today's lessons", value: '4', hint: 'Monday teaching load'),
  TeacherTimetableKpi(label: 'Substitutions', value: '1', hint: 'Tuesday · JSS 2B'),
  TeacherTimetableKpi(label: 'Free periods', value: '9', hint: 'Available planning blocks'),
];
...
const teacherTimetableLessons = <TeacherTimetableLesson>[
  ...
  TeacherTimetableLesson(id: 'TUE-0840-S1A', day: 'Tuesday', date: '15 Sep', time: '8:40–9:20', className: 'SS 1A', subject: 'Further Mathematics', topic: 'Functions', room: 'D06', status: TeacherTimetableLessonStatus.scheduled),
  ...
  TeacherTimetableLesson(id: 'WED-1020-S1A', day: 'Wednesday', date: '16 Sep', time: '10:20–11:00', className: 'SS 1A', subject: 'Further Mathematics', topic: 'Domain and range', room: 'D06', status: TeacherTimetableLessonStatus.scheduled),
  ...
  TeacherTimetableLesson(id: 'FRI-0840-S1A', day: 'Friday', date: '18 Sep', time: '8:40–9:20', className: 'SS 1A', subject: 'Further Mathematics', topic: 'Composite functions', room: 'D06', status: TeacherTimetableLessonStatus.scheduled),
...
const teacherTimetableNotices = <TeacherTimetableNotice>[
  ...
  TeacherTimetableNotice(title: 'Room change', detail: 'SS 1A on Friday remains in D06. No room changes this week.'),
];
